...
/*
 * The native apps are this deployment's pages as much as the site is, but they
 * are not served from it: Capacitor loads their bundled pages from an origin of
 * its own, on a hostname the app claims in mobile/capacitor.config.json --
 * capacitor:// on iOS, https:// on Android. Matched exactly, so no subdomain
 * or lookalike rides along.
 */
export const APP_ORIGINS = ['capacitor://app.map-to-gpx.com', 'https://app.map-to-gpx.com'];
